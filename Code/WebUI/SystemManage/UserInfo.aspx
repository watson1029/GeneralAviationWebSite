        ...
        <form id="form_edit"  method="post">
                <table class="table_edit">
                    ...
                    <tr>
                        ...
                        <td class="tdar">
                            <input id="Mobile" name="Mobile" style="width: 100%" maxlength="11" type="text" validType='mobile' required="true" class="easyui-validatebox" />
                        </td>
            ...
            InitGird: function () {
                $('#tab_list').datagrid({
                    ...
                    columns: [[
                        ...
                        { title: '状态', field: 'Status', formatter: function (value, rec, index) { return value == 0 ? '正常' : '冻结' }, width: 100 },
                        { title: '是否通航用户', field: 'IsGeneralAviation', formatter: function (value, rec, index) { return value == 0 ? '否' : '是' }, width: 100 },
                        {
