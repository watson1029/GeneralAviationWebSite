...
public partial class FlightPlan_CurrentPlanFinishAuditForm1 : BasePage
{
    ...
    private void GetAuditRecord()
    {
        ...
        auditList = insdal.GetAllNodeInstance(planid, (int)TWFTypeEnum.CurrentPlan).Where(u => !(User.RoleName.Contains(u.RoleName) && u.NextId != Guid.Empty)).Skip(1).ToList();
    }
}