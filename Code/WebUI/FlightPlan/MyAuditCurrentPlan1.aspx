<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeFile="MyAuditCurrentPlan1.aspx.cs" Inherits="FlightPlan_MyAuditCurrentPlan1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    { field: 'cbx', checkbox: true },
                        ...
                        { title: '应答机编码', field: 'SsrCode', width: 80 },
                         {
                          ...
                          {
                              title: '实际落地时间', field: 'SIBT', width: 120, formatter: function (value, rec, index) {
                                  var timesstamp = new Date(value.dateValFormat());
                                  return timesstamp.format("yyyy-MM-dd HH:mm:ss");
            ...
            //审核
            Audit: function (uid) {
                $("#audit").dialog("open").dialog('setTitle', '审核').dialog('refresh', 'CurrentPlanAuditForm1.aspx?id=' + uid);
