        ...
        <div class="panel-body" style="width: 96%;">
            <table class="form">
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <input id="AuditComment" name="AuditComment" required="true" maxlength="400" style="width: 800px; height: 150px" type="text" data-options="multiline:true" class="easyui-textbox" />
                    </td>
                </tr>
            </table>
        </div>
