 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnSubmitRepetPlanBatchImport.aspx.cs" Inherits="FlightPlan_UnSubmitRepetPlanBatchImport" %> 
        <table class="table_edit">       
            <tr>
             ...
             <tr>
               ...
               <td>
                <p style="color:red">最多导入500条数据</p><a target="_blank" href="<%=Page.ResolveUrl("~/Files/长期计划申报模板.xlsx")%>">模板下载</a>
            </td>
                     </tr>
