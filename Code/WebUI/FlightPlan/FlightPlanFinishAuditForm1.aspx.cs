...
public partial class FlightPlan_FlightPlanFinishAuditForm1 : BasePage
{
    ...
    private void GetAuditRecord()
    {
        ...
        auditList = insdal.GetAllNodeInstance(planid, (int)TWFTypeEnum.FlightPlan).Where(u => !(User.RoleName.Contains(u.RoleName) && u.NextId != Guid.Empty)).Skip(1).ToList();
    }
}