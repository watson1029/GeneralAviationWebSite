<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeFile="MyAuditRepetPlan1.aspx.cs" Inherits="FlightPlan_MyAuditRepetPlan1" %>
        ...
        <form id="form_batchaudit" method="post">
            <table class="table_edit">
                ...
                <tr>
                    <th>审核意见：</th>
                    <td colspan="3">
                        <input id="BatchAuditComment" name="BatchAuditComment"  maxlength="400" style="width: 400px; height: 150px" type="text" data-options="multiline:true" class="easyui-textbox" />
                    </td>
