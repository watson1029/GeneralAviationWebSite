<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentPlanFinishAuditForm1.aspx.cs" Inherits="FlightPlan_CurrentPlanFinishAuditForm1" %>
        ...
        <div class="panel-body" style="width: 96%;">
            <table class="form">
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <input id="ActualStartTime" name="ActualStartTime" editable="false" required="true" class="easyui-datebox" style="height: 25px" />
                    </td>
                    <th class="formTitle">实际落地时间</th>
                    <td class="formValue">
                        <input id="ActualEndTime" name="ActualEndTime" editable="false" required="true" class="easyui-datebox" validtype="md['#StartDate']" style="height: 25px" />
                    </td>
                </tr>
                <tr>
