<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeFile="MyFinishAuditCurrentPlan.aspx.cs" Inherits="FlightPlan_MyFinishAuditCurrentPlan" %>
    ...
    <script type="text/javascript">
        ...
        Main = {
            ...
            EditData: function (uid) {
                $("#edit").dialog("open").dialog('setTitle', '编辑').dialog('refresh', 'CurrentPlanFinishAuditForm.aspx?id=' + uid);
