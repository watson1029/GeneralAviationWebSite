...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        Main = {
            ...
            EditData: function (uid) {
                $("#edit").dialog("open").dialog('setTitle', '查看').dialog('refresh', 'FlightPlanFinishAuditForm.aspx?id=' + uid);
    ...
    <div id="edit-buttons">
         <a href="javascript:;"
            class="easyui-linkbutton" onclick="$('#edit').dialog('close');return false;">关闭</a>
    </div>
