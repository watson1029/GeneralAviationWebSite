    ...
    dj.dyWorkTable.prototype = {
        addCWorkRow: function () {
            if (this.cRowIndex < this.cMaxRowCount) {
                this.cRowIndex++;
                j("#" + this.cconid).append("<tr><td class=\"formValue\"><input id='CFlyHeight" + this.cRowIndex + "' name='CFlyHeight" + this.cRowIndex + "' type=\"text\"  maxlength=\"50\"/></td><td class=\"formValue\"><input id='CRadius" + this.cRowIndex + "' name='CRadius" + this.cRowIndex + "' type=\"text\" maxlength=\"50\"/></td><td class=\"formValue\"><input id='CWorkName" + this.cRowIndex + "'  name='CWorkName" + this.cRowIndex + "' type=\"text\"  maxlength=\"50\"/></td><td class=\"formValue\"><input id='CLatLong" + this.cRowIndex + "' name='CLatLong" + this.cRowIndex + "' type=\"text\"  maxlength=\"50\"/></td></tr>");
            }
            else {
        ...
        addPWorkRow: function () {
            if (this.pRowIndex < this.pMaxRowCount) {
                this.pRowIndex++;
                var str = "<tr><td class=\"formValue\"><input id='PFlyHeight_row" + this.pRowIndex + "' name='PFlyHeight_row" + this.pRowIndex + "' type=\"text\"  maxlength=\"50\"/></td>";
                for (var i = 1; i <= this.pColIndex; i++) {
                    str += "<td class=\"formValue\"><input id='PWorkName_row" + this.pRowIndex + "_col" + i + "'  name='PWorkName_row" + this.pRowIndex + "_col" + i + "' type=\"text\"  maxlength=\"50\"/></td><td class=\"formValue\"><input id='PWorkLatLong_row" + this.pRowIndex + "_col" + i + "' name='PWorkLatLong_row" + this.pRowIndex + "_col" + i + "' type=\"text\" maxlength=\"50\"/></td>";
                }
                str += "</tr>";
        ...
        addPWorkCol: function () {
            if (this.pColIndex < this.pMaxColCount) {
                ...
                for (var i = 0; i < this.pRowIndex; i++) {
                    j("#" + this.pconid + " tr:eq(" + i + ") ").append("<td class=\"formValue\"><input id='PWorkName_row" + (i + 1) + "_col" + this.pColIndex + "'  name='PWorkName_row" + (i + 1) + "_col" + this.pColIndex + "' type=\"text\"  maxlength=\"50\"/></td><td class=\"formValue\"><input id='PWorkLatLong_row" + (i + 1) + "_col" + this.pColIndex + "' name='PWorkLatLong_row" + (i + 1) + "_col" + this.pColIndex + "' type=\"text\"  maxlength=\"50\"/></td>");
                }
        ...
        addHWorkRow: function () {
            if (this.hRowIndex < this.hMaxRowCount) {
                this.hRowIndex++;
                var str = "<tr><td class=\"formValue\"><input id='HFlyHeight_row" + this.hRowIndex + "' name='HFlyHeight_row" + this.hRowIndex + "' type=\"text\"  maxlength=\"50\"/></td>";
                str += "<td class=\"formValue\"><input id='HDistance_row" + this.hRowIndex + "' name='HDistance_row" + this.hRowIndex + "' type=\"text\" maxlength=\"50\"/></td>";
                for (var i = 1; i <= this.hColIndex; i++) {
                    str += "<td class=\"formValue\"><input id='HWorkName_row" + this.hRowIndex + "_col" + i + "'  name='HWorkName_row" + this.hRowIndex + "_col" + i + "' type=\"text\"  maxlength=\"50\"/></td><td class=\"formValue\"><input id='HWorkLatLong_row" + this.hRowIndex + "_col" + i + "' name='HWorkLatLong_row" + this.hRowIndex + "_col" + i + "' type=\"text\"  maxlength=\"50\"/></td>";
                }
                str += "</tr>";
        ...
        addHWorkCol: function () {
            if (this.hColIndex < this.hMaxColCount) {
                ...
                for (var i = 0; i < this.hRowIndex; i++) {
                    j("#" + this.hconid + " tr:eq(" + i + ") ").append("<td class=\"formValue\"><input id='HWorkName_row" + (i + 1) + "_col" + this.hColIndex + "'  name='HWorkName_row" + (i + 1) + "_col" + this.hColIndex + "' maxlength=\"50\"/></td><td class=\"formValue\"><input id='HWorkLatLong_row" + (i + 1) + "_col" + this.hColIndex + "' name='HWorkLatLong_row" + (i + 1) + "_col" + this.hColIndex + "' type=\"text\"  maxlength=\"50\"/></td>");
                }
