<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeFile="AdPicture.aspx.cs" Inherits="Advertisment_AdPicture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server" >
   ...
   <table id="tab_list">
    ...
    <%--列表 end--%>
        <%--添加 修改 start--%>
    <div id="edit" class="easyui-dialog" style="width: 500px; height: 400px;"
        ...
        Main = {
            ...
            InitGird: function () {
                $('#tab_list').datagrid({
                    ...
                    sortName: 'AdvWebSiteID', //排序字段
                    idField: 'AdvWebSiteID', //标识字段,主键
                    iconCls: '', //标题左边的图标
                    width: '99%', //宽度
                    ...
                    columns: [[
                        { title: '图片名称', field: 'AdvSuiteName', width: 150 },
                        { title: '创建时间', field: 'CreateTime', width: 150 },
                                  {
                                      title: '是否可用', field: 'IsUsed', width: 80, formatter: function (value, rec) {
                                          return value == 1 ? "是" : "否";
                                      }
                                  },
                        {
                            title: '操作', field: 'AdvWebSiteID', width: 50, formatter: function (value, rec) {
            ...
            //打开添加窗口
            OpenWin: function () {
                $("#edit").dialog("open").dialog('setTitle', '新增').dialog('refresh', 'AdPictureAdd.aspx');;
            ...
            Save: function (uid) {
                ...
                var fileInfo = dj.getCmp("PicPaths").getUploadedFiles();
                $("#PicPathsInfo").val(fileInfo);
            ...
            EditData: function (uid) {
                $("#edit").dialog("open").dialog('setTitle', '编辑').dialog('refresh', 'AdPictureAdd.aspx?id=' + uid);;
