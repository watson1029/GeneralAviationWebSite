...
<body class="easyui-layout" style="padding:10px 10px;">
    ...
    <table id="dg" title="通航资料" style="width: 99%; height: 99%" data-options="pageSize:10,rownumbers:true,singleSelect:true,pagination:true,method:'post',toolbar:'#toolbar'">
        <thead>
            <tr>
