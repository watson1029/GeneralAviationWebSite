    ...
    <div class="main">
        <div class="center">
            <div class="adBox">
                <ul class="adpic">
                    <li>
                        <img src="images/rollimages/rollimg1.jpg" alt="" /></li>
                    <li>
                        <img src="images/rollimages/rollimg2.jpg" alt="" /></li>
                    <li>
                        <img src="images/rollimages/rollimg3.jpg" alt="" /></li>
                    <li>
                        <img src="images/rollimages/rollimg4.jpg" alt="" /></li>
                    <li>
                        <img src="images/rollimages/rollimg5.jpg" alt="" /></li>
                    <li>
                        <img src="images/rollimages/rollimg6.jpg" alt="" /></li>
                </ul>
                <ul class="hd">
                    <li class=" on"></li>
                    <li class=" "></li>
