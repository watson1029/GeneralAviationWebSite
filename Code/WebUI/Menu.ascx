...
<%--    <div class="searchboxdiv">
        ...
        <label id="newslabel" style="color: red" onclick="Menu.click('news')">新闻</label>
        <label id="supplydemandlabel" onclick="Menu.click('supplydemand')">供求</label>
        <label id="companyintrolabel" onclick="Menu.click('companyintro')">企业</label>
    </div>--%>
    <div class="nav-box">
        <ul>
